...
describe("shopify format", () => {
  ...
  describe("with react-i18next (t)", () => {
    ...
    it("handles cardinal pluralization lookups", () => {
      ...
      expect(t("cardinal_pluralization", { count: 1 })).toBe(
        "I have 1 car.",
      );
      expect(t("cardinal_pluralization", { count: 2 })).toBe(
        "I have 2 cars.",
      );
    });
    ...
    it("allows explicit lookup of cardinal pluralization subkeys", () => {
      ...
      expect(t("cardinal_pluralization.one", { count: 0 })).toBe(
        "I have 0 car.",
      );
    });
    ...
    it("prefers explicit 0 keys in cardinal pluralization lookups", () => {
      ...
      expect(t("cardinal_pluralization", { count: 0 })).toBe(
        "I have no cars.",
      );
    });
    ...
    it("handles ordinal pluralization lookups (using ordinal: true)", () => {
      ...
      expect(
        t("ordinal_pluralization", { count: 1, ordinal: true }),
      ).toBe("This is my 1st car");
      expect(
        t("ordinal_pluralization", { count: 2, ordinal: true }),
      ).toBe("This is my 2nd car");
      expect(
        t("ordinal_pluralization", { count: 3, ordinal: true }),
      ).toBe("This is my 3rd car");
      expect(
        t("ordinal_pluralization", { count: 4, ordinal: true }),
      ).toBe("This is my 4th car");
    });
  ...
  describe("with react-i18next (Trans)", () => {
    ...
    it("handles basic lookups", () => {
      const TestComponent = () => (
        <>
          ...
          <Trans i18nKey="string_with_interpolation" values={{casual_name: "Joe", date: "Monday"}}/>
          <Trans i18nKey="string_with_repeated_interpolation" values={{casual_name: "Joe"}}/>
        </>
      );
      const { container } = render(<TestComponent />);
      expect(container.childNodes[0]).toHaveTextContent("Hello world!");
      expect(container.childNodes[1]).toHaveTextContent("Hello Joe! Today is Monday.");
    ...
    it("does not fail when given excess values", () => {
      const TestComponent = () => (
        <>
          <Trans i18nKey="string_with_interpolation" values={{
            casual_name: "Joe",
            date: "Monday",
            unnecessary: "This value is not mentioned by any interpolation",
          }}/>
      ...
      expect(container.childNodes[0]).toHaveTextContent("Hello Joe! Today is Monday.");
    });
    ...
    it("handles ordinal pluralization lookups (using ordinal: true)", () => {
      const TestComponent = () => (
        <>
          <Trans i18nKey="ordinal_pluralization" values={{count: 1, ordinal: true}}/>
          <Trans i18nKey="ordinal_pluralization" values={{count: 2, ordinal: true}}/>
          <Trans i18nKey="ordinal_pluralization" values={{count: 3, ordinal: true}}/>
          <Trans i18nKey="ordinal_pluralization" values={{count: 4, ordinal: true}}/>
        </>
      );
      const { container } = render(<TestComponent />);
    ...
    it("allows explicit lookup of ordinal pluralization subkeys", () => {
      const TestComponent = () => (
        <>
          <Trans i18nKey="ordinal_pluralization.ordinal.one" count={2} values={{ordinal: true}}/>
          <Trans i18nKey="ordinal_pluralization.ordinal.one" values={{ordinal: 2}}/>
        </>
      );
      const { container } = render(<TestComponent />);
