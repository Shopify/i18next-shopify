...
```js
// Note: The `Intl.PluralRules` API is required for this plugin's plural handling.
//   If your target environments do not support this API, you may need to polyfill it.
//   This plugin's plural handling is not compatible with i18next's fallback
//   to JSON format v3 plural handling.
